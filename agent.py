...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, layer_1=64, layer_2=64, use_dropout=False, use_dueling=False, use_double=False):
        ...
        ======
            ...
            use_dropout (bool): if 'True' add dropout layer
            use_dueling (bool): if 'True' use dueling agent
            use_double (bool): if 'True' use DDQN else DQN
        """
